...
class TrancePage extends StatefulWidget {
 TrancePage({Key key, this.title}) : super(key: key);
  ...
  @override
  _TrancePageState createState() => _TrancePageState();
}

class _TrancePageState extends State<TrancePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        backgroundColor: Color(0xff640d14),
